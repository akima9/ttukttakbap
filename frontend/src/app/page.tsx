...
export default function HomePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center gap-10">
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="flex items-center gap-8">
          <button
            ...
            className="w-12 h-12 rounded-full bg-orange-100 text-orange-500 text-2xl font-bold hover:bg-orange-200 transition-colors"
          >
            -
          </button>
      ...
      <Button onClick={() => router.push(`/menu?people=${people}`)}>
        메뉴 추천받기
      </Button>
    </div>
  )
