...
export default function PeoplePicker({ menuId }: { menuId: string }) {
  ...
  return (
    <div className="min-h-[calc(100vh-6.5rem)] flex flex-col items-center justify-center gap-10">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-800">몇 명이 드세요?</h1>
      ...
      <Button onClick={() => router.push(`/ingredients?people=${people}&menuId=${menuId}`)} className="max-w-xs">
        재료 보기
      </Button>
    </div>
  )
