...
class MenuEntityTest {
    ...
    fun `메뉴를 저장하고 조회할 수 있다`() {
        val menu = Menu(name = "김치찌개", description = "얼큰한 김치찌개", imageUrl = "", cookTimeMinutes = 30, difficulty = Difficulty.EASY)
    ...
    fun `difficulty는 문자열로 저장된다`() {
        val menu = Menu(name = "불고기", description = "달콤한 불고기", imageUrl = "", cookTimeMinutes = 20, difficulty = Difficulty.MEDIUM)
